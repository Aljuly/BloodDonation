...
/****** Object:  Database [BloodDonationDB]    Script Date: 04.05.2018 17:56:23 ******/
CREATE DATABASE [BloodDonationDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BloodDonationDB', FILENAME = N'D:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\BloodDonationDB.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'BloodDonationDB_log', FILENAME = N'D:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\BloodDonationDB_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [BloodDonationDB] SET COMPATIBILITY_LEVEL = 120
GO
...
ALTER DATABASE [BloodDonationDB] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
